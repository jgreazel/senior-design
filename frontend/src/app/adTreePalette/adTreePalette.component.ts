...
@Component({
  selector: 'ad-tree-palette',
  templateUrl: './adTreePalette.component.html',
  styleUrls: ['./adTreePalette.component.css']
})
export class AdTreePalette {
  ...
  public paletteNodeData: Array<go.ObjectData> = this.AdTreePalette;
